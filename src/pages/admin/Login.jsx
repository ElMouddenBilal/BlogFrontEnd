  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center px-4">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        />
        <div
          className="absolute -bottom-16 -right-16 h-80 w-80 rounded-full blur-3xl opacity-30"
          ...
          <div className="p-8">
            ...
            <div className="mb-8 text-center">
              ...
              <p className="mt-1 text-sm text-white/70">
                Inicia sesión para gestionar tus blogs
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="inline-flex items-center gap-2 select-none">
                  <input
                    type="checkbox"
                    className="h-4 w-4 rounded border-white/30 bg-transparent text-[#FFEB00] focus:ring-[#FFEB00]/30"
                  />
