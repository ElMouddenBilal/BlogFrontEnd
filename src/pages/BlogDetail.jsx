...
const BlogDetail = () => {
  ...
  return (
    <section className="min-h-screen px-2 sm:px-6 lg:px-12 py-20 text-white flex justify-center items-start">
      {/* ⬇️ Más ancho: de max-w-4xl a max-w-7xl */}
      <div className="max-w-7xl w-full bg-white text-[#000957] rounded-3xl shadow-2xl overflow-hidden relative animate-fade-in">
        ...
        {/* Imagen principal (más alta en pantallas grandes) */}
        {blog.imageUrl && (
          <img
            src={blog.imageUrl}
            alt={blog.title}
        ...
        <div className="p-6 sm:p-10 lg:p-14">
          ...
          {/* Contenido dividido por párrafos (un poco más ancho el texto, pero legible) */}
